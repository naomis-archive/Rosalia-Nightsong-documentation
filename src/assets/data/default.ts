...
export const defCommands: defCommandInt[] = [
  ...
  {
    name: 'art',
    description: 'Returns an embed containing artwork depicting Rosalia.',
  },
  {
    name: 'announce',
    description:
      'Restricted to the OWNER_ID account, this command will have Rosalia send [message] to the BOT_CHANNEL in the BOT_GUILD.',
    parameters: '[message]',
  },
  {
    name: 'help',
